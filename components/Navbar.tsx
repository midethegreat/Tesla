      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex justify-between items-center h-20 md:h-24">
          ...
          <div className="hidden lg:flex items-center space-x-10">
            <a href="#" className="text-amber-400 font-bold text-[9px] uppercase tracking-[0.2em] hover:text-white transition">Home</a>
            <a href="#plans" className="text-gray-400 font-bold text-[9px] uppercase tracking-[0.2em] hover:text-amber-400 transition">Investment</a>
            <a href="#how-it-works" className="text-gray-400 font-bold text-[9px] uppercase tracking-[0.2em] hover:text-amber-400 transition">Strategy</a>
            <a href="#about" className="text-gray-400 font-bold text-[9px] uppercase tracking-[0.2em] hover:text-amber-400 transition">About</a>
          </div>
          ...
          <div className="lg:hidden">
            <button onClick={() => setIsOpen(!isOpen)} className="text-white p-2 hover:bg-white/5 rounded-xl transition">
          ...
          <div className="bg-[#14120e] backdrop-blur-3xl border border-white/10 rounded-[2rem] py-10 px-8 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] relative overflow-hidden">
            ...
            <div className="space-y-8 flex flex-col items-center relative z-10">
              <div className="flex flex-col items-center gap-6 w-full">
                <a href="#" onClick={() => setIsOpen(false)} className="text-amber-400 text-sm font-black uppercase tracking-[0.3em] transition">Home</a>
                <a href="#plans" onClick={() => setIsOpen(false)} className="text-gray-400 text-sm font-black uppercase tracking-[0.3em] hover:text-white transition">Investment</a>
                <a href="#how-it-works" onClick={() => setIsOpen(false)} className="text-gray-400 text-sm font-black uppercase tracking-[0.3em] hover:text-white transition">Methodology</a>
                <a href="#about" onClick={() => setIsOpen(false)} className="text-gray-400 text-sm font-black uppercase tracking-[0.3em] hover:text-white transition">Stats</a>
              </div>
